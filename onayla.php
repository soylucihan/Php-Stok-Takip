...
$sayfabasi=50;  
$sorgu=mysql_query("SELECT *  FROM `uye` WHERE `onay` != '0'"); 
...
$bilgi = mysql_query("SELECT *  FROM `uye` WHERE `onay` != '0' limit $basla, $sayfabasi");	
if($bilgi)
	{	
...
echo"<td width=\"130\" height=\"30\"><a href=\"uye-sil.php?id=$satir[id]\"><img src=\"images\sil.jpg\" border=\"0\"></a></td></tr>";
	}
